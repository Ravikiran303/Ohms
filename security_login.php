...
<body>
  ...
  <form class="p-5" method="POST" action="<?php echo $_SERVER['PHP_SELF'];?>">
    <img src="">
    <p class="h4 mb-4 text-center" style="border-radius: 5px;height:30px; font-size: 20px;font-family: Bookman Old style; font-weight: bold;">Security Sign In</p>

    <input type="text" id="defaultLoginFormEmail" class="form-control mb-4" placeholder="University ID" name="sec_id">
